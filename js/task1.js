 ...
 */
function addAqiData() {
	var oInput1=document.getElementById("aqi-city-input").value;
	var oInput2=document.getElementById("aqi-value-input").value;
	var oCity=oInput1.trim();
	var oValue=oInput2.trim();
